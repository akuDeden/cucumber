# advance-table Snapshots

Halaman Tables > Advanced Table. Semua file di sini menunjukkan Tables page aktif.
...
**Entry point**: Dashboard > tombol Tables > tab Advanced Table
